  ...
  return (
    <div onClick={()=> {navigate(`/car-details/${car._id}`); scrollTo(0,0)}} className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
      ...
      <div className='relative h-48 overflow-hidden'> 
        ...
        {(car.fuel_type.toLowerCase() === 'electric' || car.fuel_type.toLowerCase() === 'hybrid') && <p className='absolute top-4 right-4 bg-green-500/90 text-white text-xs px-2.5 py-1 rounded-full'>Eco-Friendly</p>}
