  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <button type="submit" className='flex items-center justify-center gap-2 px-4 py-2.5 mt-4 bg-blue-600 text-white rounded-md font-medium w-full cursor-pointer'>
