...
const Cars = () => {
  ...
  const applyFilter = async ()=>{
    ...
    // Sort eco-friendly cars first
    filtered.sort((a, b) => {
      const ecoTypes = ['electric', 'hybrid'];
      const aEco = ecoTypes.includes(a.fuel_type.toLowerCase());
      const bEco = ecoTypes.includes(b.fuel_type.toLowerCase());
